...
import com.example.ecomarket.adapters.BooksAdapter;
...
//these are recycler views
        ...
        ArrayList<Books> recentBookList = new ArrayList<>();
        ArrayList<Books> popularBookList = new ArrayList<>();
        ArrayList<Books> programmingBookList = new ArrayList<>();
        ArrayList<Books> novelBookList = new ArrayList<>();
        ...
        userAcount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String logged =  getIntent().getStringExtra("Mail");
                Intent intent = new Intent(AppHome.this, Account.class);
