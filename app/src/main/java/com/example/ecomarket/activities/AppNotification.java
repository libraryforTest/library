...
import com.example.ecomarket.Notification;
import com.example.ecomarket.adapters.NotificationAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAcount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String logged =  getIntent().getStringExtra("Mail");
                Intent intent = new Intent(AppNotification.this, Account.class);
