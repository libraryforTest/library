...
TextView bookTitle, bookAuthor, bookISBN, bookCategory, uploadedBy, booksAvailable, descriptions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String coverUrl = intent.getStringExtra(AppHome.COVER_URL);
        String title = intent.getStringExtra(AppHome.TITLE);
        String author = intent.getStringExtra(AppHome.AUTHOR);
        String description = intent.getStringExtra(AppHome.DESCRIPTIONS);
        final String remaining = intent.getStringExtra(AppHome.AVAILABLE);
        String category = intent.getStringExtra(AppHome.CATEGORY);
        String theisbn = intent.getStringExtra(AppHome.ISBN);
        String uploader = intent.getStringExtra(AppHome.UPLOADED_BY);
        final String reqs = intent.getStringExtra(AppHome.REQUESTS);
...
//                            Toast.makeText(BookDetails.this, response, Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Intent intent = getIntent();
                String isbn = intent.getStringExtra(AppHome.ISBN);
                Map<String, String> params = new HashMap<String, String>();
    ...
    public void sendData(final String isBn){
        Intent intent = getIntent();
        final String coverUrl = intent.getStringExtra(AppHome.COVER_URL);
        final String title = intent.getStringExtra(AppHome.TITLE);
        final String author = intent.getStringExtra(AppHome.AUTHOR);
        final String isbn = intent.getStringExtra(AppHome.ISBN);
